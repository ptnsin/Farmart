...
const NAV_ITEMS = [
  { key: "orders", label: "หน้าคำสั่งซื้อ", icon: ShoppingCart, href: "/employee/orders" },
  { key: "warehouse", label: "หน้าคลังสินค้า", icon: Warehouse, href: "/employee/warehouse" },
  { key: "shipping", label: "หน้าการขนส่ง", icon: Truck, href: "/employee/shipping" },
];
